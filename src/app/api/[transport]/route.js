...
// Lógica de presupuestación compartida con el chat de la app (/api/agent/chat):
// misma resolución de líneas y mismos totales por los dos caminos.
import {
    norm, buildQuoteItems, calcTotales, lineaView, productView,
} from '@/lib/agentQuoting';
