    ...
    return (
        <div className={`flex flex-col md:flex-row h-full overflow-hidden ${className} app-tab`}>
            ...
            <div className={`${mobileTab === 'products' ? 'block' : 'hidden'} md:block w-full md:w-2/3 p-3 md:p-8 overflow-y-auto bg-slate-50 dark:bg-slate-950`}>
                ...
                <div className="bg-white dark:bg-slate-800 rounded-xl md:rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm p-0 mb-6 md:mb-8 overflow-visible relative z-20">
                ...
                {!selectedProduct ? (
                    <div className="animate-fade-in">
                        <div className="mb-4 md:mb-6 flex flex-col gap-3 md:gap-4">
                            ...
                            <div className="flex gap-2 overflow-x-auto pb-2 -mx-3 px-3 md:mx-0 md:px-0 md:flex-wrap w-[calc(100%+24px)] md:w-full scrollbar-hide snap-x">
